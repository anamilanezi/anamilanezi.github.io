...
const data = {
  pt: {
    ...
    details: ['Criatividade :)', 'Português nativo', 'Inglês fluente'],
  ...
  en: {
    ...
    details: ['Creativity :)', 'Native in Portuguese', 'Fluent in English'],
...
//   const translateIterables = iterName => {
//     for (let i = 0; i < iterName.length; i++) {
//         console.log(iterName[i].innerText)
//     //   iterName[i].innerText = chosenLang.iterName[i];
//     }
//   };
